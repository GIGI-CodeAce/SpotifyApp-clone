    ...
    return(
      <>
        ...
        <div
          ...
          <div className="absolute font-semibold bg-slate-800 animate-pulse ml-60 h-10 w-30 rounded-xl sm:ml-72 mt-10 "></div>
          <div className="absolute bg-slate-800 animate-pulse ml-60 h-10 w-60 rounded-xl mt-[89px] sm:ml-72">
          ...
          <div className="absolute bg-slate-800 w-10 h-6 animate-pulse rounded-xl sm:ml-[429px] ml-95 mt-36 ">
      ...
      <ol className="list-disc list-outside marker:text-slate-700 pr-2 pl-5 ml-1 border-4 border-black bg-black">
          <li
            ...
            <span className="ml-1 animate-pulse w-40 h-6 bg-slate-700 rounded-xl inline-block max-w-[200px] sm:max-w-[500px] truncate"></span>
            <span className="absolute right-[35%] w-20 h-6 bg-slate-700 rounded-xl animate-pulse"></span>
            <span className="absolute right-[10%] w-20 h-6 bg-slate-700 rounded-xl animate-pulse"></span>
          </li>
          <li
            className="rounded-md bg-[hsl(215,28%,14%)] mb-1 py-2 pr-2 pl-4 h-11 relative">
            <span className="ml-1 animate-pulse w-40 h-6 bg-slate-700 rounded-xl inline-block max-w-[200px] sm:max-w-[500px] truncate"></span>
