    ...
    return(
      <>
        ...
        <div
          ...
          <div className="absolute font-semibold bg-slate-800 animate-pulse ml-56 h-10 sm:w-30 w-20 rounded-xl sm:ml-72 mt-10 ">
            {/* Album text */}
          </div>
          <div className="absolute bg-slate-800 text-green-600 text-center justify-center pt-2 animate-pulse ml-55 h-10 sm:w-60 w-40 rounded-xl mt-[89px] sm:ml-72">
